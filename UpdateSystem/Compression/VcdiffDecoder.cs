using System;
using System.IO;
using CodeElements.UpdateSystem.Compression.Checksum;
...
namespace CodeElements.UpdateSystem.Compression
{
	...
	public sealed class VcdiffDecoder
	{
		...
		public static void Decode(Stream original, Stream delta, Stream output)
		{
			...
			var instance = new VcdiffDecoder(original, delta, output);
			instance.Decode();
		}
		...
		private void ReadCodeTable()
		{
			...
			var compressedTableLength = IOHelper.ReadBigEndian7BitEncodedInt(delta) - 2;
