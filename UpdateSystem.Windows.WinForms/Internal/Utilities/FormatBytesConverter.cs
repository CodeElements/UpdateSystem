namespace CodeElements.UpdateSystem.Windows.WinForms.Internal.Utilities
{
    public static class FormatBytesConverter
    {
        /// <summary>
        ...
        {
            // Get absolute value
            var absolute = byteCount < 0 ? -1 * byteCount : byteCount;
